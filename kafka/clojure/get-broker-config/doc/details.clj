{:aliases {"downgrade" "upgrade"},
 ...
 :compile-path
 "/home/ptisnovs/src/message-queues-examples/kafka/clojure/get-broker-config/target/default/classes",
 :dependencies
 ...
 :native-path
 "/home/ptisnovs/src/message-queues-examples/kafka/clojure/get-broker-config/target/default/native",
 :offline? false,
 :pedantic? ranges,
 :plugin-repositories
 [["central"
 ...
 [["central"
  ...
  ["clojars" {:url "https://repo.clojars.org/"}]],
 :resource-paths
 ("/home/ptisnovs/src/message-queues-examples/kafka/clojure/get-broker-config/dev-resources"
  "/home/ptisnovs/src/message-queues-examples/kafka/clojure/get-broker-config/resources"),
 :root
 "/home/ptisnovs/src/message-queues-examples/kafka/clojure/get-broker-config",
 :source-paths
 ("/home/ptisnovs/src/message-queues-examples/kafka/clojure/get-broker-config/src"),
 :target-path
 "/home/ptisnovs/src/message-queues-examples/kafka/clojure/get-broker-config/target/default",
 :test-paths
 ("/home/ptisnovs/src/message-queues-examples/kafka/clojure/get-broker-config/test"),
